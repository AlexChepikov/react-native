...
const FirstRoute = () => (
  <View style={styles.containerRoute}>
    <ScrollView>
      <Text style={styles.textWeight}>{'\t'}{'\t'}Головной офис издательства «ЮНИЛАЙН» находится в городе Смоленске, Россия. Основан 3 апреля 2001 года.</Text>
      ...
      <Text style={styles.textWeight}>{'\t'}{'\t'}Контакты представительства:</Text>
      ...
      <Text>{'\t'}{'\t'}Сайт: <Text style={styles.textStyle} onPress={() => Linking.openURL('http://yuniline.ru').catch(err => console.error('No links', err))}>http://yuniline.ru</Text></Text>
      <Text style={styles.textWeight}>{'\t'}{'\t'}Адрес для корреспонденции:</Text>
      <Text>{'\t'}{'\t'}Адрес: 214020, Россия, г. Смоленск, a/я 20</Text>
      <Text>{'\t'}{'\t'}E-mail: total@yuniline.ru</Text>
      <Text style={styles.textWeight}>{'\t'}{'\t'}Для рекламодателей:</Text>
      <Text>{'\t'}{'\t'}Тел: 8 (4812) 358-777</Text>
...
const SecondRoute = () => (
  <View style={styles.containerRoute}>
    <ScrollView>
      <Text style={styles.textWeight}>{'\t'}{'\t'}ООО «ЮНИЛАЙН - БЕЛ» - официальное представительство издательства «ЮНИЛАЙН» в Республике Беларусь. Основано 13 декабря 2016 года в городе Минске.</Text>
      ...
      <Text>{'\t'}{'\t'}Сайт: <Text style={styles.textStyle} onPress={() => Linking.openURL('http://yuniline.by').catch(err => console.error('No links', err))}>http://yuniline.by</Text></Text>
      <Text style={styles.textWeight}>{'\t'}{'\t'}Для рекламодателей:</Text>
...
const ThirdRoute = () => (
  <View style={styles.containerRoute}>
    <ScrollView>
      <Text style={styles.textWeight}>{'\t'}{'\t'}ТОО «ЮНИЛАЙН КАЗАХСТАН»-официальное представительство ООО «ЮНИЛАЙН» на территории Республики Казахстан. Основано 16 января 2013 года в городе Алматы.</Text>
      ...
      <Text>{'\t'}{'\t'}Сайт: <Text style={styles.textStyle} onPress={() => Linking.openURL('https://yuniline.kz').catch(err => console.error('No links', err))}>https://yuniline.kz</Text></Text>
      <Text style={styles.textWeight}>{'\t'}{'\t'}Для рекламодателей:</Text>
      <Text>{'\t'}{'\t'}Тел: +7(727) 330-94-49</Text>
      <Text>{'\t'}{'\t'}E-mail: total@yuniline.kz</Text>
      <Text style={styles.textWeight}>{'\t'}{'\t'}Для корреспонденции:</Text>
      <Text>{'\t'}{'\t'}Тел: +7(727) 330-94-49</Text>
      <Text>{'\t'}{'\t'}E-mail: total@yuniline.kz</Text>
    </ScrollView>
  </View>
...
const FoorRoute = () => (
  <View style={styles.containerRoute}>
    <ScrollView>
      <Text style={styles.textWeight}>{'\t'}{'\t'}Официальное представительство «ЮНИЛАЙН» в Эстонии было открыто в 2013 году в г. Тарту. «ЮНИЛАЙН ЕВРОПА» занимается распространением печатной продукции в странах Европы.</Text>
      ...
      <Text>{'\t'}{'\t'}Сайт: <Text style={styles.textStyle} onPress={() => Linking.openURL('https://yuniline.com').catch(err => console.error('No links', err))}>https://yuniline.com</Text></Text>
      <Text style={styles.textWeight}>{'\t'}{'\t'}Для рекламодателей:</Text>
      <Text>{'\t'}{'\t'}Тел: +3 725 6867747</Text>
      <Text>{'\t'}{'\t'}E-mail: v.radionenkov@yuniline.com</Text>
    </ScrollView>
