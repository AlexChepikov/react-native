...
const ThirdRoute = () => (
  <View style={styles.containerRoute}>
    <ScrollView>
      ...
      <Text h4 style={styles.textAlign}>Тематика/Тиражи</Text>
      ...
      <Text h4 style={styles.textAlign}>Контент маркетинг</Text>
      ...
      <Text h4 style={styles.textAlign}>По вопросам рекламы - Ирина Мальцева (E-mail: i.malceva@yuniline.ru .Телефон 8(915)641-41-91)</Text>
      <Text style={styles.textWeight}>{'\t'}{'\t'}Контакты представительства:</Text>
      <Text>{'\t'}{'\t'}Адрес: 214025, Смоленская область, г. Смоленск, ул. Вяземская, д. 3</Text>
      <Text>{'\t'}{'\t'}Часы работы: с 9:00 до 18:00</Text>
      <Text>{'\t'}{'\t'}Тел: 8 (4812) 358-777</Text>
      ...
      <View style={styles.tabBar}>
        {props.navigationState.routes.map((route, i) => {
          ...
          return (
            ...
            >
              <Animated.Text style={[{color}, styles.textSize]}>{route.title}</Animated.Text>
            </TouchableOpacity>
          )
        })}
      </View>
